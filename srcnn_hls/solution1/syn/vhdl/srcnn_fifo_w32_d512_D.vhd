...
entity srcnn_fifo_w32_d512_D is
    generic (
...
architecture arch of srcnn_fifo_w32_d512_D is

    -- component
    component srcnn_fifo_w32_d512_D_ram is
    generic (
        MEM_STYLE  : string  := "distributed";
...
begin
----------------------- Instantiation -----------------------
    U_srcnn_fifo_w32_d512_D_ram : srcnn_fifo_w32_d512_D_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity srcnn_fifo_w32_d512_D_ram is
    generic (
        MEM_STYLE   : string  := "distributed";
        DATA_WIDTH  : integer := 32;
        ADDR_WIDTH  : integer := 9;
...
architecture arch of srcnn_fifo_w32_d512_D_ram is
