...
entity srcnn_load_conv2_params_Pipeline_VITIS_LOOP_163_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of srcnn_load_conv2_params_Pipeline_VITIS_LOOP_163_2 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln163_fu_220_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal trunc_ln161_2_read_reg_317 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal trunc_ln163_fu_236_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln163_reg_335 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln163_reg_335_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln163_reg_335_pp0_iter2_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln163_reg_335_pp0_iter3_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln163_reg_335_pp0_iter4_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln163_reg_335_pp0_iter5_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln163_reg_335_pp0_iter6_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln163_reg_335_pp0_iter7_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln163_reg_335_pp0_iter8_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln163_reg_335_pp0_iter9_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal bitcast_ln165_fu_281_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal bitcast_ln165_reg_350 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln165_1_fu_302_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln165_fu_266_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal j_fu_90 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln163_fu_226_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_j_1 : STD_LOGIC_VECTOR (6 downto 0);
    signal zext_ln161_2_cast_fu_208_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal zext_ln163_fu_232_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal add_ln165_1_fu_250_p2 : STD_LOGIC_VECTOR (11 downto 0);
    signal zext_ln165_fu_256_p1 : STD_LOGIC_VECTOR (62 downto 0);
    signal sext_ln161_cast_fu_204_p1 : STD_LOGIC_VECTOR (62 downto 0);
    signal add_ln165_fu_260_p2 : STD_LOGIC_VECTOR (62 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln163_fu_220_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln163_fu_220_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
    ...
    add_ln163_fu_226_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j_1) + unsigned(ap_const_lv7_1));
    add_ln165_1_fu_250_p2 <= std_logic_vector(unsigned(zext_ln161_2_cast_fu_208_p1) + unsigned(zext_ln163_fu_232_p1));
    add_ln165_fu_260_p2 <= std_logic_vector(unsigned(zext_ln165_fu_256_p1) + unsigned(sext_ln161_cast_fu_204_p1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln163_fu_220_p2)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln163_fu_220_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    bitcast_ln165_fu_281_p1 <= m_axi_gmem_w2_RDATA;
    conv2_weights_local_0_0_address1 <= zext_ln165_1_fu_302_p1(9 - 1 downto 0);

    conv2_weights_local_0_0_ce1_assign_proc : process(ap_enable_reg_pp0_iter10, ap_block_pp0_stage0_11001)
    begin
        if (((ap_enable_reg_pp0_iter10 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
            conv2_weights_local_0_0_ce1 <= ap_const_logic_1;
        else 
            conv2_weights_local_0_0_ce1 <= ap_const_logic_0;
        end if; 
    end process;

    conv2_weights_local_0_0_d1 <= bitcast_ln165_reg_350;

    conv2_weights_local_0_0_we1_assign_proc : process(ap_enable_reg_pp0_iter10, trunc_ln161_2_read_reg_317, ap_block_pp0_stage0_11001, trunc_ln163_reg_335_pp0_iter9_reg)
    begin
        if (((ap_enable_reg_pp0_iter10 = ap_const_logic_1) and (trunc_ln163_reg_335_pp0_iter9_reg = ap_const_lv1_0) and (trunc_ln161_2_read_reg_317 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
            conv2_weights_local_0_0_we1 <= ap_const_logic_1;
        else 
            conv2_weights_local_0_0_we1 <= ap_const_logic_0;
        end if; 
    end process;

    conv2_weights_local_0_1_address1 <= zext_ln165_1_fu_302_p1(9 - 1 downto 0);

    conv2_weights_local_0_1_ce1_assign_proc : process(ap_enable_reg_pp0_iter10, ap_block_pp0_stage0_11001)
    begin
        if (((ap_enable_reg_pp0_iter10 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
            conv2_weights_local_0_1_ce1 <= ap_const_logic_1;
        else 
            conv2_weights_local_0_1_ce1 <= ap_const_logic_0;
        end if; 
    end process;

    conv2_weights_local_0_1_d1 <= bitcast_ln165_reg_350;

    conv2_weights_local_0_1_we1_assign_proc : process(ap_enable_reg_pp0_iter10, trunc_ln161_2_read_reg_317, ap_block_pp0_stage0_11001, trunc_ln163_reg_335_pp0_iter9_reg)
    begin
        if (((ap_enable_reg_pp0_iter10 = ap_const_logic_1) and (trunc_ln163_reg_335_pp0_iter9_reg = ap_const_lv1_1) and (trunc_ln161_2_read_reg_317 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
            conv2_weights_local_0_1_we1 <= ap_const_logic_1;
        else 
            conv2_weights_local_0_1_we1 <= ap_const_logic_0;
        end if; 
    end process;

    conv2_weights_local_1_0_address1 <= zext_ln165_1_fu_302_p1(9 - 1 downto 0);

    conv2_weights_local_1_0_ce1_assign_proc : process(ap_enable_reg_pp0_iter10, ap_block_pp0_stage0_11001)
    begin
        if (((ap_enable_reg_pp0_iter10 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
            conv2_weights_local_1_0_ce1 <= ap_const_logic_1;
        else 
            conv2_weights_local_1_0_ce1 <= ap_const_logic_0;
        end if; 
    end process;

    conv2_weights_local_1_0_d1 <= bitcast_ln165_reg_350;

    conv2_weights_local_1_0_we1_assign_proc : process(ap_enable_reg_pp0_iter10, trunc_ln161_2_read_reg_317, ap_block_pp0_stage0_11001, trunc_ln163_reg_335_pp0_iter9_reg)
    begin
        if (((ap_enable_reg_pp0_iter10 = ap_const_logic_1) and (trunc_ln163_reg_335_pp0_iter9_reg = ap_const_lv1_0) and (trunc_ln161_2_read_reg_317 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
            conv2_weights_local_1_0_we1 <= ap_const_logic_1;
        else 
            conv2_weights_local_1_0_we1 <= ap_const_logic_0;
        end if; 
    end process;

    conv2_weights_local_1_1_address1 <= zext_ln165_1_fu_302_p1(9 - 1 downto 0);

    conv2_weights_local_1_1_ce1_assign_proc : process(ap_enable_reg_pp0_iter10, ap_block_pp0_stage0_11001)
    begin
        if (((ap_enable_reg_pp0_iter10 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
            conv2_weights_local_1_1_ce1 <= ap_const_logic_1;
        else 
            conv2_weights_local_1_1_ce1 <= ap_const_logic_0;
        end if; 
    end process;

    conv2_weights_local_1_1_d1 <= bitcast_ln165_reg_350;

    conv2_weights_local_1_1_we1_assign_proc : process(ap_enable_reg_pp0_iter10, trunc_ln161_2_read_reg_317, ap_block_pp0_stage0_11001, trunc_ln163_reg_335_pp0_iter9_reg)
    begin
        if (((ap_enable_reg_pp0_iter10 = ap_const_logic_1) and (trunc_ln163_reg_335_pp0_iter9_reg = ap_const_lv1_1) and (trunc_ln161_2_read_reg_317 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
            conv2_weights_local_1_1_we1 <= ap_const_logic_1;
        else 
    ...
    icmp_ln163_fu_220_p2 <= "1" when (ap_sig_allocacmp_j_1 = ap_const_lv7_40) else "0";
    ...
    m_axi_gmem_w2_WVALID <= ap_const_logic_0;
        sext_ln161_cast_fu_204_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sext_ln161),63));

        sext_ln165_fu_266_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(add_ln165_fu_260_p2),64));

    tmp_3_fu_285_p4 <= i(4 downto 2);
    tmp_4_fu_294_p4 <= ((tmp_3_fu_285_p4 & trunc_ln165) & lshr_ln2_reg_339_pp0_iter9_reg);
    trunc_ln161_2_read_reg_317 <= trunc_ln161_2;
    trunc_ln163_fu_236_p1 <= ap_sig_allocacmp_j_1(1 - 1 downto 0);
    zext_ln161_2_cast_fu_208_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln161_2),12));
    zext_ln163_fu_232_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_j_1),12));
    zext_ln165_1_fu_302_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_4_fu_294_p4),64));
    zext_ln165_fu_256_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln165_1_fu_250_p2),63));
end behav;
