...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename output_tile \
    op interface \
    ports { output_tile_address0 { O 9 vector } output_tile_ce0 { O 1 bit } output_tile_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'output_tile'"
}
}
