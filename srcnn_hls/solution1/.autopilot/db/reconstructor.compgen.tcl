...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { layer3_output_tile_0_address0 { O 9 vector } layer3_output_tile_0_ce0 { O 1 bit } layer3_output_tile_0_q0 { I 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_pixel_h_loc \
    op interface \
    ports { pixel_h_loc_dout { I 9 vector } pixel_h_loc_num_data_valid { I 3 vector } pixel_h_loc_fifo_cap { I 3 vector } pixel_h_loc_empty_n { I 1 bit } pixel_h_loc_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_pixel_w_loc \
    op interface \
    ports { pixel_w_loc_dout { I 8 vector } pixel_w_loc_num_data_valid { I 3 vector } pixel_w_loc_fifo_cap { I 3 vector } pixel_w_loc_empty_n { I 1 bit } pixel_w_loc_read { O 1 bit } } \
} "
}
