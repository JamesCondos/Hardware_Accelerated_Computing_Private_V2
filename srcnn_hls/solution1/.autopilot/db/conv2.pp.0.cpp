...
#pragma HLS ARRAY_PARTITION variable=conv2_weights cyclic factor=4 dim=2
...
#pragma HLS ARRAY_PARTITION variable=input_tile cyclic factor=4 dim=1
 ...
 STREAM_READ_CONV2:
    for (int feat = 0; feat < 64; feat++) {
        VITIS_LOOP_33_1: for (int i = 0; i < 17; i++) {
            VITIS_LOOP_34_2: for (int j = 0; j < 17; j++) {
    ...
    for (int out_feat = 0; out_feat < 32; out_feat++) {
        VITIS_LOOP_43_3: for (int i = 0; i < 17; i++) {
            VITIS_LOOP_44_4: for (int j = 0; j < 17; j++) {
...
#pragma HLS PIPELINE II=1
 ...
 VITIS_LOOP_62_5: for (int j = 0; j < 17; j++) {
        ...
        RELU_CONV2:
        for (int i = 0; i < 17; i++) {
            VITIS_LOOP_73_6: for (int j = 0; j < 17; j++) {
#pragma HLS PIPELINE II = 1
 if (layer2_output_tile[feat][i][j] < 0) {
    ...
    STREAM_OUT_CONV2:
    for (int feat = 0; feat < 32; feat++) {
        VITIS_LOOP_85_7: for (int i = 0; i < 17; i++) {
            VITIS_LOOP_86_8: for (int j = 0; j < 17; j++) {
