...
{
 int padding = 1/2;
 VITIS_LOOP_11_1: for (int out_feat = 0; out_feat < 32; out_feat++) {
   ...
   VITIS_LOOP_13_2: for (int out_feat_y = 0; out_feat_y < 255; out_feat_y++) {
    ...
    VITIS_LOOP_15_3: for (int out_feat_x = 0; out_feat_x < 255; out_feat_x++) {
     ...
     VITIS_LOOP_26_4: for (int in_feat = 0; in_feat < 64 ; in_feat++) {

      VITIS_LOOP_28_5: for (int kernel_x = 0; kernel_x < 1; kernel_x++) {

       VITIS_LOOP_30_6: for (int kernel_y = 0; kernel_y < 1; kernel_y++) {
