           ...
           ftmap_t output_ftmap[64][255][255])
{
 ...
 VITIS_LOOP_14_1: for (int out_feat = 0; out_feat < 64; out_feat++) {

  VITIS_LOOP_16_2: for (int out_feat_y = 0; out_feat_y < 255; out_feat_y++) {

   VITIS_LOOP_18_3: for (int out_feat_x = 0; out_feat_x < 255; out_feat_x++) {
    ...
    VITIS_LOOP_29_4: for (int in_feat = 0; in_feat < 1; in_feat++) {

     VITIS_LOOP_31_5: for (int kernel_x = 0; kernel_x < 9; kernel_x++) {


      VITIS_LOOP_34_6: for (int kernel_y = 0; kernel_y <9; kernel_y++) {
