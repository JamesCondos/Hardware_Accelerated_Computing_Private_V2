...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler srcnn_precompute_conv12_halo_c1_vec_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename conv2_buf \
    op interface \
    ports { conv2_buf_address0 { O 18 vector } conv2_buf_ce0 { O 1 bit } conv2_buf_we0 { O 1 bit } conv2_buf_d0 { O 32 vector } } \
} "
} else {
