...
set C_modelArgList {
	...
	{ layer1_output float 32 regular {array 4161600 { 0 3 } 0 1 } {global 1}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "input_ftmap", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "layer1_output", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ layer1_output_address0 sc_out sc_lv 22 signal 3 } 
	{ layer1_output_ce0 sc_out sc_logic 1 signal 3 } 
	{ layer1_output_we0 sc_out sc_logic 1 signal 3 } 
	{ layer1_output_d0 sc_out sc_lv 32 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer1_output_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "layer1_output", "role": "d0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_generic_fmax_double_s_fu_381", "Parent" : "0",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_generic_fmin_double_s_fu_386", "Parent" : "0",
		...
		"Port" : [
			{"Name" : "x", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_7ns_8ns_13_1_1_U6", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1348358420", "Max" : "1348358420"}
	, {"Name" : "Interval", "Min" : "1348358420", "Max" : "1348358420"}
]}
...
set Spec2ImplPortList { 
	...
	layer1_output { ap_memory {  { layer1_output_address0 mem_address 1 22 }  { layer1_output_ce0 mem_ce 1 1 }  { layer1_output_we0 mem_we 1 1 }  { layer1_output_d0 mem_din 1 32 } } }
}
