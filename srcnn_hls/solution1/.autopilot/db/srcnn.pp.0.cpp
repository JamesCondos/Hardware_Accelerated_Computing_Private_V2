...
{
#line 29 "C:/Users/james/Documents/Hardware_Final_Project_Private_V2/golden/srcnn_hls/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=srcnn
# 16 "src/srcnn.cpp"

#line 7 "C:/Users/james/Documents/Hardware_Final_Project_Private_V2/golden/srcnn_hls/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=srcnn
# 16 "src/srcnn.cpp"
...
#pragma HLS BIND_STORAGE variable=conv1_weights_local type=RAM_S2P impl=lutram
...
#pragma HLS ARRAY_PARTITION variable=conv3_weights_local type=cyclic factor=2 dim=4
 ...
 const int TILE_NUM_ROW = 255/17;
 const int TILE_NUM_COLUMN = 255/17;
 const int TILE_NUM = TILE_NUM_ROW*TILE_NUM_COLUMN;
...
#pragma HLS DATAFLOW
 ...
 int pixel_h = (tile_n / TILE_NUM_ROW) * 17;
      int pixel_w = (tile_n % TILE_NUM_ROW) * 17;
         ftmap_t layer3_output_tile[1][17][17];
...
#pragma HLS STREAM variable=conv1_to_conv2 depth=512
 ...
 const int P = 9 / 2;
    ...
    ftmap_t layer1_output_tile[64][17][17];
...
#pragma HLS BIND_OP variable=acc op=fadd impl=dsp
...
#pragma HLS STREAM variable=conv2_to_conv3 depth=512
 ftmap_t input_tile[64][17][17];
    ftmap_t layer2_output_tile[32][17][17];
 ...
 layer2_output_tile[out_feat][i][j] = conv2_biases[out_feat];
    ...
    for (int feat = 0; feat < 32; feat++) {
     in_feature_loop_conv2:
        for (int in_feat = 0; in_feat < 64; in_feat++) {
...
#pragma HLS PIPELINE II = 1
 layer3_output_tile[0][i][j] = conv3_biases[0];
    ...
    in_feat_loop_conv3:
    for (int in_feat = 0; in_feat < 32; in_feat++) {
