...
set C_modelArgMapList {[ 
	{ "Name" : "add_ln389", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ add_ln389 sc_in sc_lv 11 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln389", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "add_ln389", "role": "default" }} , 
...
set Spec2ImplPortList { 
	add_ln389 { ap_none {  { add_ln389 in_data 0 11 } } }
