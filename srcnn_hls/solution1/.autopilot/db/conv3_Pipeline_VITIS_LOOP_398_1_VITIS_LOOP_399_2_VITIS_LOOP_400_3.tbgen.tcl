set moduleName conv3_Pipeline_VITIS_LOOP_398_1_VITIS_LOOP_399_2_VITIS_LOOP_400_3
set isTopModule 0
...
set C_modelName {conv3_Pipeline_VITIS_LOOP_398_1_VITIS_LOOP_399_2_VITIS_LOOP_400_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_tile float 32 regular {array 9248 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
...
set portList { 
	...
	{ conv2_to_conv3_dout sc_in sc_lv 32 signal 1 } 
	{ conv2_to_conv3_num_data_valid sc_in sc_lv 10 signal 1 } 
	{ conv2_to_conv3_fifo_cap sc_in sc_lv 10 signal 1 } 
	{ conv2_to_conv3_empty_n sc_in sc_logic 1 signal 1 } 
	{ conv2_to_conv3_read sc_out sc_logic 1 signal 1 } 
	{ input_tile_address0 sc_out sc_lv 14 signal 0 } 
...
set Spec2ImplPortList { 
	input_tile { ap_memory {  { input_tile_address0 mem_address 1 14 }  { input_tile_ce0 mem_ce 1 1 }  { input_tile_we0 mem_we 1 1 }  { input_tile_d0 mem_din 1 32 } } }
