...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_trunc_ln165 \
    op interface \
    ports { trunc_ln165 { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { zext_ln161_2 { I 11 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_trunc_ln161_2 \
    op interface \
    ports { trunc_ln161_2 { I 1 vector } } \
} "
}
