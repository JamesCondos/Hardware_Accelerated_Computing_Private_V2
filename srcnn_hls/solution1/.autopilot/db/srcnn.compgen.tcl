...
set name srcnn_sitodp_32s_64_4_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler srcnn_layer1_output_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler srcnn_layer2_output_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { conv1_weights_address0 { O 13 vector } conv1_weights_ce0 { O 1 bit } conv1_weights_q0 { I 32 vector } conv1_weights_address1 { O 13 vector } conv1_weights_ce1 { O 1 bit } conv1_weights_q1 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { conv2_weights_address0 { O 11 vector } conv2_weights_ce0 { O 1 bit } conv2_weights_q0 { I 32 vector } conv2_weights_address1 { O 11 vector } conv2_weights_ce1 { O 1 bit } conv2_weights_q1 { I 32 vector } } \
} "
} else {
