...
#pragma HLS STREAM variable=conv2_to_conv3 depth=512
 ...
 const int P = 5 / 2;
    ...
    VITIS_LOOP_23_1: for (int feat = 0; feat < 32; feat++) {
        VITIS_LOOP_24_2: for (int i = 0; i < 17; i++) {
            VITIS_LOOP_25_3: for (int j = 0; j < 17; j++) {
    ...
    for (int i = 0; i < 17; i++) {
        VITIS_LOOP_34_4: for (int j = 0; j < 17; j++) {
#pragma HLS PIPELINE II = 1
 layer3_output_tile[0][i][j] = conv3_biases[0];
    ...
    for (int in_feat = 0; in_feat < 32; in_feat++) {
        VITIS_LOOP_43_5: for (int th = 0; th < 17; th++) {
            VITIS_LOOP_44_6: for (int tw = 0; tw < 17; tw++) {
                VITIS_LOOP_45_7: for (int kh = 0; kh < 5; kh++) {
                    VITIS_LOOP_46_8: for (int kw = 0; kw < 5; kw++) {
                        int pad_h = (int)fminf(fmaxf(th + kh - P, 0), 17 - 1);
                        int pad_w = (int)fminf(fmaxf(tw + kw - P, 0), 17 - 1);
