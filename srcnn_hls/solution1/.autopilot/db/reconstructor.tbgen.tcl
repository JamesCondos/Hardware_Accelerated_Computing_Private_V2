...
set C_modelArgList {
	...
	{ pixel_h_loc int 9 regular {fifo 0}  }
	{ pixel_w_loc int 8 regular {fifo 0}  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "gmem_out", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "output_ftmap","offset": { "type": "dynamic","port_name": "output_ftmap","bundle": "ctrl"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "pixel_h_loc", "interface" : "fifo", "bitwidth" : 9, "direction" : "READONLY"} , 
 	{ "Name" : "pixel_w_loc", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ m_axi_gmem_out_RFIFONUM sc_in sc_lv 9 signal 0 } 
	...
	{ output_ftmap_dout sc_in sc_lv 64 signal 1 } 
	{ output_ftmap_num_data_valid sc_in sc_lv 4 signal 1 } 
	{ output_ftmap_fifo_cap sc_in sc_lv 4 signal 1 } 
	{ output_ftmap_empty_n sc_in sc_logic 1 signal 1 } 
	{ output_ftmap_read sc_out sc_logic 1 signal 1 } 
	{ layer3_output_tile_0_address0 sc_out sc_lv 9 signal 2 } 
	{ layer3_output_tile_0_ce0 sc_out sc_logic 1 signal 2 } 
	{ layer3_output_tile_0_q0 sc_in sc_lv 32 signal 2 } 
	{ pixel_h_loc_dout sc_in sc_lv 9 signal 3 } 
	{ pixel_h_loc_num_data_valid sc_in sc_lv 3 signal 3 } 
	{ pixel_h_loc_fifo_cap sc_in sc_lv 3 signal 3 } 
	{ pixel_h_loc_empty_n sc_in sc_logic 1 signal 3 } 
	{ pixel_h_loc_read sc_out sc_logic 1 signal 3 } 
	{ pixel_w_loc_dout sc_in sc_lv 8 signal 4 } 
	{ pixel_w_loc_num_data_valid sc_in sc_lv 3 signal 4 } 
	{ pixel_w_loc_fifo_cap sc_in sc_lv 3 signal 4 } 
	{ pixel_w_loc_empty_n sc_in sc_logic 1 signal 4 } 
	{ pixel_w_loc_read sc_out sc_logic 1 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "pixel_h_loc_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "pixel_h_loc", "role": "dout" }} , 
 	{ "name": "pixel_h_loc_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "pixel_h_loc", "role": "num_data_valid" }} , 
 	{ "name": "pixel_h_loc_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "pixel_h_loc", "role": "fifo_cap" }} , 
 	{ "name": "pixel_h_loc_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "pixel_h_loc", "role": "empty_n" }} , 
 	{ "name": "pixel_h_loc_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "pixel_h_loc", "role": "read" }} , 
 	{ "name": "pixel_w_loc_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "pixel_w_loc", "role": "dout" }} , 
 	{ "name": "pixel_w_loc_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "pixel_w_loc", "role": "num_data_valid" }} , 
 	{ "name": "pixel_w_loc_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "pixel_w_loc", "role": "fifo_cap" }} , 
 	{ "name": "pixel_w_loc_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "pixel_w_loc", "role": "empty_n" }} , 
 	{ "name": "pixel_w_loc_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "pixel_w_loc", "role": "read" }}  ]}
...
set Spec2ImplPortList { 
	...
	pixel_h_loc { ap_fifo {  { pixel_h_loc_dout fifo_port_we 0 9 }  { pixel_h_loc_num_data_valid fifo_status_num_data_valid 0 3 }  { pixel_h_loc_fifo_cap fifo_update 0 3 }  { pixel_h_loc_empty_n fifo_status 0 1 }  { pixel_h_loc_read fifo_data 1 1 } } }
	pixel_w_loc { ap_fifo {  { pixel_w_loc_dout fifo_port_we 0 8 }  { pixel_w_loc_num_data_valid fifo_status_num_data_valid 0 3 }  { pixel_w_loc_fifo_cap fifo_update 0 3 }  { pixel_w_loc_empty_n fifo_status 0 1 }  { pixel_w_loc_read fifo_data 1 1 } } }
}
