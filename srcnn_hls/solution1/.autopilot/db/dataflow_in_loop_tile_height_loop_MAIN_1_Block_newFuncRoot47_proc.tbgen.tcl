set moduleName dataflow_in_loop_tile_height_loop_MAIN_1_Block_newFuncRoot47_proc
set isTopModule 0
...
set C_modelName {dataflow_in_loop_tile_height_loop_MAIN.1_Block_newFuncRoot47_proc}
set C_modelType { float 32 }
set C_modelArgList {
	{ conv3_biases_local float 32 regular {array 1 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "conv3_biases_local", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ conv3_biases_local_address0 sc_out sc_lv 1 signal 0 } 
	{ conv3_biases_local_ce0 sc_out sc_logic 1 signal 0 } 
	{ conv3_biases_local_q0 sc_in sc_lv 32 signal 0 } 
...
set Spec2ImplPortList { 
	conv3_biases_local { ap_memory {  { conv3_biases_local_address0 mem_address 1 1 }  { conv3_biases_local_ce0 mem_ce 1 1 }  { conv3_biases_local_q0 in_data 0 32 } } }
}
